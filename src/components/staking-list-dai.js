...
let vaults = [
    {
        ...
        "logo3": "/images/cDAI.svg",
        "name": "DAI Vault\n3 Days Locking",
        "description": "Supply WBTC",
        "apy": "~8%",
        "link": "/vault-dai-3days"
    },
    {
        "hidden": false,
        "short_name": "DAI Vault",
        ...
        "description": "Supply WBTC",
        "apy": "~21%",
        "link": "/vault-dai-90days"
    }
]

export default class VaultListDai extends React.Component {
    constructor(props) {
        super(props)
        this.state = {}
    }
